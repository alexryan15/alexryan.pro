  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <h1 className='text-4xl sm:text-7xl font-bold text-[#ccd6f6]'>Alex Ryan</h1>
        <h2 className='text-4xl sm:text-7xl font-bold text-[#8892b0]'>I'm a Computer Science Student.</h2>
        <p className='text-[#8892b0] py-4 max-w-[700px] '>I am a student at Penn State studying Computer Science. In the summer of 2022, 
