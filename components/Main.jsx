      ...
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center">
        <div>
          <h1 className="py-4 text-gray-700">
            Hi, I'm <span className="text-[#7510F7]"> Alex</span>
          </h1>
          <h1 className="py-2 text-gray-700">Computer Science Student</h1>
          <p className="py-4 text-gray-600 max-w-[70%] m-auto font-light text-xl">
          ...
          <div className="flex items-center justify-between max-w-[330px] m-auto py-4">
            <a
              ...
              rel="noreferrer"
            >
              <div className="rounded-full border-2 shadow-lg shadow-gray-400 p-6 cursor-pointer hover:scale-110 ease-in duration-300 hover:border-[#7510F7]">
                <FaLinkedinIn />
              </div>
            </a>
            <a
